const brazilianPortuguese = {
  ...
  passwordLength: 'A senha deve conter 6 dígitos',
  confirmPassword: 'As senhas não conferem',
  name: 'Nome',
  password: 'Senha',
  passwordConfirm: 'Confirme a senha',
  continue: 'Continuar',
  disclaimer: 'Antes de começar precisamos que você nos informe alguns dados',
  logout: 'Sair',
  newTransaction: 'Nova transação',
  cancel: 'Cancelar',
  transactionDisclaimer: 'Insira os dados para a transação',
  insertValue: 'Insira o valor',
  description: 'Escreva uma mensagem',
  yourPassword: 'Sua senha',
  destinyCpf: 'CPF do destinatário',
